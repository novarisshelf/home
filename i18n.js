...
const dict = {
  bn: {
    ...
    owner_theme_update_error: 'থিম পরিবর্তন করা যায়নি। আবার চেষ্টা করুন।',
    ...
    settings_theme_site_wide: 'এটি পুরো সাইটের জন্য প্রযোজ্য — সব ভিজিটর এই থিম দেখবেন।',
  ...
  en: {
    ...
    owner_theme_update_error: 'Could not update the theme. Please try again.',
    ...
    settings_theme_site_wide: 'This applies to the whole site — every visitor will see this theme.',
    settings_lang_bn: 'বাংলা',
    settings_lang_en: 'English',
